# This is where we will store our global configurations. We’ll use the different parameters here to
# customize the experience of PITS and adjust some of its internal settings.
